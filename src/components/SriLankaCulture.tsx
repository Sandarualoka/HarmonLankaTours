...
const places = [
  { image: 'https://images.pexels.com/photos/19574565/pexels-photo-19574565.jpeg?auto=compress&cs=tinysrgb&w=600', title: 'Sigiriya', tag: 'Ancient Kingdom', alt: 'Sigiriya Rock Fortress - ancient UNESCO World Heritage Site in Sri Lanka' },
  { image: 'https://images.pexels.com/photos/31194791/pexels-photo-31194791.jpeg?auto=compress&cs=tinysrgb&w=600', title: 'Galle Fort', tag: 'UNESCO Heritage', alt: 'Galle Dutch Fort - colonial UNESCO heritage site on Sri Lanka south coast' },
  { image: 'https://images.pexels.com/photos/13784932/pexels-photo-13784932.jpeg?auto=compress&cs=tinysrgb&w=600', title: 'Yala', tag: 'Wildlife Reserve', alt: 'Yala National Park - wildlife safari destination in Sri Lanka' },
  { image: 'https://images.pexels.com/photos/29644514/pexels-photo-29644514.jpeg?auto=compress&cs=tinysrgb&w=600', title: 'Mirissa', tag: 'South Coast', alt: 'Mirissa beach - scenic coastal destination in southern Sri Lanka' },
  { image: 'https://images.pexels.com/photos/321570/pexels-photo-321570.jpeg?auto=compress&cs=tinysrgb&w=600', title: 'Nuwara Eliya', tag: 'Tea Country', alt: 'Nuwara Eliya tea plantations - hill country in Sri Lanka' },
  { image: 'https://images.pexels.com/photos/34714986/pexels-photo-34714986.jpeg?auto=compress&cs=tinysrgb&w=600', title: 'Ella', tag: 'Hill Country', alt: 'Ella mountain village - scenic hill country destination in Sri Lanka' },
];
